...
def write_image_to_s3(img):
    ...
    response = s3.put_object(ACL='public-read', Body=jpg_data.tostring(), Bucket='people-tracking-images',Key=file_name)

    image_url = 'https://s3.amazonaws.com/people-tracking-images/'+file_name
    return image_url
...
#     global threshold
#     threshold = jsonState["state"]["reported"]["threshold"]
...
def greengrass_infinite_infer_run():
    ...
    try:
        ...
        while True:
            ...
            parsed_inference_results = model.parseResult(model_type, raw_inference_result)
            # {
            #     "output": [
